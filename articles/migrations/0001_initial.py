    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('join_hits', models.PositiveIntegerField(default=0)),
                ('join_desc', models.TextField()),
                ('join_period', models.DateField()),
                ('join_status', models.BooleanField(default=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('review_article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='review_comment', to='articles.review')),
            ],
        ),
    ]
