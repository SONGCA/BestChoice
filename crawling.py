...
festival_id = 1
for page_num in range(167):
    url = f'https://www.mcst.go.kr/kor/s_culture/festival/festivalList.jsp?pMenuCD=&pCurrentPage={page_num+1}&pSearchType=01&pSearchWord=&pSeq=&pSido=&pOrder=01up&pPeriod=&fromDt=20220101&toDt=20241231'
